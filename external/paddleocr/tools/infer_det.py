...
def main():
    ...
    save_text_dir = os.path.join(config['Global'][
                'save_res_path'], "text_results")
    ...
    for file in get_image_file_list(config['Global']['infer_img']):
        ...
        if isinstance(post_result, dict):
            ...
            for k in post_result.keys():
                ...
                save_det_path = os.path.join(config['Global'][
        ...
        file_id = os.path.splitext(os.path.basename(file))[0] + '.txt'
        save_text_path = os.path.join(save_text_dir, file_id)
