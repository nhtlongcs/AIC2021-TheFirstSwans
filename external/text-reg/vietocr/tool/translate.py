...
def resize(w, h, expected_height, image_min_width, image_max_width, keep_width):
...
def process_image(image, image_height, image_min_width, image_max_width, keep_width=False):
    img = image.convert('RGB')

    w, h = img.size
    new_w, image_height = resize(w, h, image_height, image_min_width, image_max_width, keep_width)
...
def process_image_v2(image, image_height, image_min_width, image_max_width):
    img = image.convert('RGB')

    w, h = img.size
    new_w, image_height = resize(w, h, image_height, image_min_width, image_max_width, keep_width=True)
...
def process_input(image, image_height, image_min_width, image_max_width, keep_width=False):
    img = process_image(image, image_height, image_min_width, image_max_width, keep_width)
    img = img[np.newaxis, ...]
